...
# * Objective: Classify whether patient survived more or less than 5 years after undergoing the surgery. If the patient survived more than 5 years, then the class is 1 else class is 0.
# * Importance of domain knowledge.
# 
...
## The Number of points in the dataset is 306
...
df_haberman['status'].unique()

## Number of classes are 2 i.e. (1,2)
...
## There are 225 instances for class 1 and 81 instances for class 2
